...
== 좋아요
=== Request
include::{snippets}/likes/post-code-comments-commentId/http-request.adoc[]
include::{snippets}/likes/post-code-comments-commentId/path-parameters.adoc[]


== 좋아요 취소
=== Request
include::{snippets}/likes/delete-code-comments-commentId/http-request.adoc[]
include::{snippets}/likes/delete-code-comments-commentId/path-parameters.adoc[]
