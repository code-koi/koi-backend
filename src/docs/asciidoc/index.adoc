...
== 즐겨찾기한 코드리뷰
=== Request
include::{snippets}/codeReviews/get-favorite-userId/http-request.adoc[]

=== Response
include::{snippets}/codeReviews/get-favorite-userId/response-fields.adoc[]
include::{snippets}/codeReviews/get-favorite-userId/response-body.adoc[]
